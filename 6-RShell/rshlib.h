...
#define RDSH_DEF_PORT           7127        //Default port #
...
int exec_client_requests_threaded(client_data_t *data); 
int rsh_execute_pipeline_threaded(int socket_fd, command_list_t *clist, char *cwd);
